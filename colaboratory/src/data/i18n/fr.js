...
export default {
  ...
  newRegionOfInterestTooltip4: "Tirez un point pour le déplacer. Double-cliquez sur une ligne pour créer un nouveau point en son milieu. Entrez un nom puis cliquez sur Valider pour enregistrer le tracé.",
