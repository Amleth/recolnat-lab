...
export default {
  ...
  newRegionOfInterestTooltip4: "Tirez un point pour le déplacer. Double-cliquez sur une ligne pour créer un nouveau point en son milieu.",
  ...
  darwinCore: {
    ...
    scientifcName: "Nom scientifique",
    class: "Classe",
    genus: "Genre",
    subGenus: "Sous-genre",
    family: "Famille",
