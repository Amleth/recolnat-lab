...
//    OrientVertex user = CreatorUtils.createUser("Robert LeRouge", g);
    OrientVertex rootWb = (OrientVertex) AccessUtils.getRootWorkbench((Vertex) user, g);
    
    OrientVertex sampleWb = CreatorUtils.createWorkbenchContent("Etude exemple", "workbench", g);
...
UpdateUtils.addWorkbenchToWorkbench(rootWb, sampleWb, user, g);
UpdateUtils.addItemToWorkbench(scripusSheet, sampleWb, user, g);
UpdateUtils.addItemToWorkbench(festucaSheet, sampleWb, user, g);
UpdateUtils.addItemToWorkbench(ophiloSheet, sampleWb, user, g);
...
UpdateUtils.addCreator(sampleWb, user, g);
UpdateUtils.addCreator(scripusSheet, user, g);
UpdateUtils.addCreator(festucaSheet, user, g);
UpdateUtils.addCreator(ophiloSheet, user, g);
